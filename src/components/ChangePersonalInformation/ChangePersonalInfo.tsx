...
const ChangePersonalInfo = () => {
  ...
  }, [success, error, authContext?.user]);
  return (
      ...
      <div className="p-7">
        <form onSubmit={handleUpdateAccount}>
          ...
          <div className="mb-5.5">
            ...
            <div className="w-full  rounded border border-stroke bg-gray px-4.5 py-3 text-black hover:cursor-not-allowed focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white ">
