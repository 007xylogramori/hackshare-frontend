...
const DiscussionResource = ({
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex w-[100%] items-center justify-between border-b border-stroke px-7 py-4 dark:border-strokedark">
        <div>
          <h3 className="text-lg font-semibold text-black dark:text-white ">
            {discuss.title}
          </h3>
          <span className=" ">@{discuss.user.username}</span>
...
export default DiscussionResource;
